...
type Stat struct {
	...
	// TODO: keep weighted average of execution times
	// Total execution time of finished containers
	TotalContainerExecutionTime float64 `protobuf:"fixed64,8,opt,name=total_container_execution_time,json=totalContainerExecutionTime,proto3" json:"total_container_execution_time,omitempty"`
	// Number of container executions
	ContainerExecutionCount int32 `protobuf:"varint,9,opt,name=container_execution_count,json=containerExecutionCount,proto3" json:"container_execution_count,omitempty"`
}
...
func (m *Stat) GetTotalContainerExecutionTime() float64 {
	if m != nil {
		return m.TotalContainerExecutionTime
	}
	return 0
}

func (m *Stat) GetContainerExecutionCount() int32 {
	if m != nil {
		return m.ContainerExecutionCount
	}
	return 0
}
...
var fileDescriptor_cf216df9f6fff44c = []byte{
	...
	,
}
...
func (m *Stat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ContainerExecutionCount != 0 {
		i = encodeVarintStat(dAtA, i, uint64(m.ContainerExecutionCount))
		i--
		dAtA[i] = 0x48
	}
	if m.TotalContainerExecutionTime != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.TotalContainerExecutionTime))))
		i--
		dAtA[i] = 0x41
	}
	if m.Timestamp != 0 {
...
func (m *Stat) Size() (n int) {
	...
	if m.ContainerExecutionCount != 0 {
		n += 1 + sovStat(uint64(m.ContainerExecutionCount))
	}
	return n
}
...
func (m *Stat) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalContainerExecutionTime", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.TotalContainerExecutionTime = float64(math.Float64frombits(v))
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContainerExecutionCount", wireType)
			}
			m.ContainerExecutionCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStat
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ContainerExecutionCount |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
